...
def simulate_trade_path(df, i, horizon):
    ...
    # skip kalau no trade atau proba belum ada (NaN di awal-awal test)
...
def calc_stats(trades_df, start_balance=1000.0):
    ...
    print("===== DL (LSTM) ATR SL/TP BACKTEST (TEST SET, WITH COST) =====")
...
def main():
    ...
    trades_df.to_csv("dl_signal_trades_test_atr_sl_tp_cost.csv", index=False)
    print("[OK] Saved trades -> dl_signal_trades_test_atr_sl_tp_cost.csv")
